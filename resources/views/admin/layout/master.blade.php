      ...
      <div class="page-sidebar " id="main-menu">
        ...
        <div class="page-sidebar-wrapper scrollbar-dynamic" id="main-menu-wrapper">
          ...
          <ul>
            ...
            <li>
              <a href="{{ route('admin.contact') }}"> <i class="fa fa-shopping-cart" aria-hidden="true"></i><span class="title">Liên hệ</span> <span class=" badge badge-disable pull-right ">203</span>
              </a>
            </li>
            <li>
