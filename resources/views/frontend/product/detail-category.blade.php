              ...
              @foreach ($products as $item)
                <li>
                  <figure>
                    ...
                    <figcaption>
                      <h4 class="aa-product-title"><a href="{{ route('frontend.detailproduct', ['id'=>$item->id]) }}">{{ Str::limit($item->product_name,30) }}</a></h4>
              ...
              <ul>
                ...
                @foreach ($products as $item)
                    <li>
                        ...
                        <h4><a href="{{ route('frontend.detailproduct', ['id'=>$item->id]) }}">{{ Str::limit($item->product_name,30) }}</a></h4>
