...
@foreach ($data as $item)
  @php
      $total = $total + (($item->product->price * $item->quantity) - ($item->product->price * $item->quantity * $item->product->sale_percent)/100);
  @endphp
@endforeach
<!-- Cart view section -->
<section id="checkout">
                         ...
                         <div class="row">
                           <div class="col-md-12">
                             <div class="aa-checkout-single-bill">
                               <input name="fullnamebill" type="text" placeholder="Họ tên*" value="{{ Auth::user()->fullname }}">
                             </div>                             
                           </div>                            
                         </div>  
                         <div class="row">
                           <div class="col-md-6">
                             <div class="aa-checkout-single-bill">
                               <input name="emailbill" type="email" placeholder="Email*" value="{{ Auth::user()->email }}">
                             </div>                             
                           </div>
                           <div class="col-md-6">
                             <div class="aa-checkout-single-bill">
                               <input name="phonebill" type="tel" placeholder="Số điện thoại*" value="{{ Auth::user()->phone }}">
                             </div>
                           </div>
                         </div>   
                         <div class="row">
                          <div class="col-md-12">
                            <div class="aa-checkout-single-bill">
                              <textarea name="address_bill" style="color: black" placeholder="Địa chỉ*" cols="8" rows="3">{{ Auth::user()->address }}</textarea>
                            </div>                             
                          </div>                            
                        </div>                                 
                       </div>
                     ...
                     <div id="collapseFour" class="panel-collapse collapse">
                       <div class="panel-body">
                         <div class="row">
                           <div class="col-md-12">
                             <div class="aa-checkout-single-bill">
                               <input name="fullname" type="text" placeholder="Họ tên*" value="{{ Auth::user()->fullname }}">
                             </div>                             
                           </div>                            
                         </div>  
                         <div class="row">
                           ...
                           <div class="col-md-6">
                             <div class="aa-checkout-single-bill">
                               <input name="phone" type="tel" placeholder="Số điện thoại*" value="{{ Auth::user()->phone }}">
                             </div>
                           </div>
                         </div> 
                         <div class="row">
                           <div class="col-md-12">
                             <div class="aa-checkout-single-bill">
                               <textarea style="color: black" name="address_ship" placeholder="Địa chỉ*" cols="8" rows="3">{{ Auth::user()->address }}</textarea>
                             </div>                             
                           </div>                            
                         </div>    
                          <div class="row">
